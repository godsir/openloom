...
export const THEMES: { id: ThemeId; label: string }[] = [
  ...
  { id: 'warm-paper', label: _t('theme.warm-paper') },
  { id: 'neon-pink', label: _t('theme.neon-pink') },
  { id: 'ember', label: _t('theme.ember') },
  { id: 'navy-gold', label: _t('theme.navy-gold') },
  { id: 'umber-cream', label: _t('theme.umber-cream') },
