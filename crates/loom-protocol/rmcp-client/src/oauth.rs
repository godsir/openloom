...
use loom_shim_stubs::keyring_store::DefaultKeyringStore;
use loom_shim_stubs::keyring_store::KeyringStore;
...
mod tests {
    ...
    use loom_shim_stubs::keyring_store::tests::MockKeyringStore;
