...
pub(crate) struct ConfiguredHandler {
    pub event_name: loom_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            loom_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            loom_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            loom_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            loom_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            loom_protocol::protocol::HookEventName::PostCompact => "post-compact",
            loom_protocol::protocol::HookEventName::SessionStart => "session-start",
            loom_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            loom_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            loom_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            loom_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<loom_protocol::items::HookPromptFragment>,
    ) -> Vec<loom_protocol::items::HookPromptFragment> {
        self.output_spiller
