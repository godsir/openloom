...
use loom_string::truncate_middle_chars;
use loom_string::truncate_middle_with_token_budget;
...
impl CodexErr {
    ...
    pub fn to_loom_protocol_error(&self) -> CodexErrorInfo {
        match self {
    ...
    pub fn to_error_event(&self, message_prefix: Option<String>) -> ErrorEvent {
        ...
        ErrorEvent {
            message,
            codex_error_info: Some(self.to_loom_protocol_error()),
        }
    }
