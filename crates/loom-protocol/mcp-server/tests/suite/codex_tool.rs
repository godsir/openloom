...
use loom_tui_stubs::spawn::CODEX_SANDBOX_NETWORK_DISABLED_ENV_VAR;
use loom_mcp_server::CodexToolCallParam;
use loom_mcp_server::ExecApprovalElicitRequestParams;
use loom_mcp_server::ExecApprovalResponse;
use loom_mcp_server::PatchApprovalElicitRequestParams;
use loom_mcp_server::PatchApprovalResponse;
use loom_protocol::protocol::FileChange;
use loom_protocol::protocol::ReviewDecision;
use loom_shell_command::parse_command;
...
fn create_expected_elicitation_request_params(
    ...
    thread_id: loom_protocol::ThreadId,
