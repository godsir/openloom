...
use loom_shim_stubs::extension_api::empty_extension_registry;
use loom_shim_stubs::login::AuthManager;
use loom_shim_stubs::login::default_client::USER_AGENT_SUFFIX;
use loom_shim_stubs::login::default_client::get_codex_user_agent;
...
impl MessageProcessor {
    ...
    pub(crate) async fn new(
        ...
        let thread_manager = Arc::new(ThreadManager::new(
            ...
            loom_tui_stubs::thread_store_from_config(config.as_ref(), state_db.clone()),
            state_db.clone(),
            installation_id,
    ...
    async fn handle_cancelled_notification(&self, params: rmcp::model::CancelledNotificationParam) {
        ...
        if let Err(e) = codex_arc
            .submit_with_id(Submission {
                ...
                op: loom_protocol::protocol::Op::Interrupt,
                trace: None,
            })
            .await
        {
