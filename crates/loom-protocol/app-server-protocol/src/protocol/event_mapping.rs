    ...
    match msg {
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                loom_protocol::protocol::AgentStatus::Errored(_)
                | loom_protocol::protocol::AgentStatus::NotFound => {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let loom_protocol::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
...
mod tests {
    ...
    use loom_protocol::protocol::CollabResumeBeginEvent;
    use loom_protocol::protocol::CollabResumeEndEvent;
    use loom_protocol::protocol::ExecCommandOutputDeltaEvent;
    use loom_protocol::protocol::ExecOutputStream;
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: loom_protocol::protocol::AgentStatus::NotFound,
        };
        ...
        assert_item_completed_server_notification(
            ...
            ItemCompletedNotification {
                ...
                item: ThreadItem::CollabAgentToolCall {
                    ...
                    agents_states: [(
                        receiver_id,
                        CollabAgentState::from(loom_protocol::protocol::AgentStatus::NotFound),
                    )]
                    .into_iter()
                    .collect(),
                },
