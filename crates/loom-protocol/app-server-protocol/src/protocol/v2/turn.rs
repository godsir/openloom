...
use loom_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use loom_protocol::plan_tool::StepStatus as CorePlanStepStatus;
...
impl crate::experimental_api::ExperimentalApi for TurnEnvironmentParams {
...
impl crate::experimental_api::ExperimentalApi for TurnStartParams {
    fn experimental_reason(&self) -> Option<&'static str> {
        if self.responsesapi_client_metadata.is_some() {
            return Some("turn/start.responsesapiClientMetadata");
        }
        if self.environments.is_some() {
            return Some("turn/start.environments");
        }
        ...
        if self.permissions.is_some() {
            return Some("turn/start.permissions");
        }
...
impl crate::experimental_api::ExperimentalApi for TurnSteerParams {
    fn experimental_reason(&self) -> Option<&'static str> {
        if self.responsesapi_client_metadata.is_some() {
            return Some("turn/steer.responsesapiClientMetadata");
        }
        None
    }
}
