...
impl From<loom_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: loom_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> loom_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => loom_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => loom_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `loom_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
...
impl crate::experimental_api::ExperimentalApi for ThreadStartParams {
    fn experimental_reason(&self) -> Option<&'static str> {
        ...
        if self.permissions.is_some() {
            return Some("thread/start.permissions");
        }
        if self.environments.as_ref().is_some_and(|v| !v.is_empty()) {
            return Some("thread/start.environments");
        }
...
impl crate::experimental_api::ExperimentalApi for ThreadStartResponse {
    fn experimental_reason(&self) -> Option<&'static str> {
        if !self.runtime_workspace_roots.is_empty() {
            return Some("thread/start.runtimeWorkspaceRoots");
        }
        if let Some(reason) = self.approval_policy.experimental_reason() {
            return Some(reason);
        }
        if self.active_permission_profile.is_some() {
            return Some("thread/start.activePermissionProfile");
        }
        None
    }
}
...
impl crate::experimental_api::ExperimentalApi for ThreadSettingsUpdateParams {
    fn experimental_reason(&self) -> Option<&'static str> {
        ...
        if self.permissions.is_some() {
            return Some("thread/settings/update.permissions");
        }
        if self.collaboration_mode.is_some() {
            return Some("thread/settings/update.collaborationMode");
        }
        None
    }
}
...
impl crate::experimental_api::ExperimentalApi for ThreadResumeParams {
    fn experimental_reason(&self) -> Option<&'static str> {
        if self.history.as_ref().is_some_and(|v| !v.is_empty()) {
        ...
        if self.permissions.is_some() {
            return Some("thread/resume.permissions");
        }
        if self.exclude_turns {
            return Some("thread/resume.excludeTurns");
        }
        if self.persist_extended_history {
...
impl crate::experimental_api::ExperimentalApi for ThreadResumeResponse {
    fn experimental_reason(&self) -> Option<&'static str> {
        ...
        if self.active_permission_profile.is_some() {
            return Some("thread/resume.activePermissionProfile");
        }
        None
    }
}
...
impl crate::experimental_api::ExperimentalApi for ThreadForkParams {
    fn experimental_reason(&self) -> Option<&'static str> {
        ...
        if self.permissions.is_some() {
            return Some("thread/fork.permissions");
        }
        if self.exclude_turns {
            return Some("thread/fork.excludeTurns");
        }
        if self.persist_extended_history {
...
impl crate::experimental_api::ExperimentalApi for ThreadForkResponse {
    fn experimental_reason(&self) -> Option<&'static str> {
        ...
        if self.active_permission_profile.is_some() {
            return Some("thread/fork.activePermissionProfile");
        }
        None
    }
}
