...
use loom_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use loom_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use loom_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use loom_protocol::items::AgentMessageContent as CoreAgentMessageContent;
...
use loom_protocol::parse_command::ParsedCommand as CoreParsedCommand;
use loom_protocol::protocol::AgentStatus as CoreAgentStatus;
use loom_protocol::protocol::ExecCommandSource as CoreExecCommandSource;
use loom_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
use loom_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use loom_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use loom_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use loom_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
impl From<loom_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: loom_protocol::models::WebSearchAction) -> Self {
        match value {
            loom_protocol::models::WebSearchAction::Search { query, queries } => {
                WebSearchAction::Search { query, queries }
            }
            loom_protocol::models::WebSearchAction::OpenPage { url } => {
                WebSearchAction::OpenPage { url }
            }
            loom_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
                WebSearchAction::FindInPage { url, pattern }
            }
            loom_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl From<loom_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: loom_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<DynamicToolCallOutputContentItem>
    for loom_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
...
impl crate::experimental_api::ExperimentalApi for CommandExecutionRequestApprovalParams {
    fn experimental_reason(&self) -> Option<&'static str> {
        ...
        if self.available_decisions.is_some() {
