...
use loom_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use loom_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use loom_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> loom_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<loom_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: loom_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            loom_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            loom_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            loom_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
