...
use loom_protocol::openai_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
use loom_protocol::openai_models::ReasoningEffort;
use loom_protocol::openai_models::default_input_modalities;
use loom_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use loom_protocol::protocol::ModelVerification as CoreModelVerification;
