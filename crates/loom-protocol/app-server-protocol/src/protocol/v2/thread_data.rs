...
use loom_protocol::protocol::SessionSource as CoreSessionSource;
use loom_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use loom_protocol::protocol::ThreadSource as CoreThreadSource;
