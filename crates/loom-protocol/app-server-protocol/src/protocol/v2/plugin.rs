...
use loom_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use loom_protocol::protocol::SkillInterface as CoreSkillInterface;
use loom_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use loom_protocol::protocol::SkillScope as CoreSkillScope;
use loom_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
