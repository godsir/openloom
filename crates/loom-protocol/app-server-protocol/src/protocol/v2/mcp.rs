...
use loom_protocol::items::McpToolCallError as CoreMcpToolCallError;
use loom_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use loom_protocol::mcp::Resource as McpResource;
pub use loom_protocol::mcp::ResourceContent as McpResourceContent;
use loom_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use loom_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from loom_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> loom_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => loom_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => loom_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => loom_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
