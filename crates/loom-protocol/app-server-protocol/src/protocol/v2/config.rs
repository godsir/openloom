...
impl crate::experimental_api::ExperimentalApi for Config {
    fn experimental_reason(&self) -> Option<&'static str> {
        ...
        for profile in self.profiles.values() {
            if let Some(reason) = profile.experimental_reason() {
                return Some(reason);
            }
        }
        None
...
impl crate::experimental_api::ExperimentalApi for ConfigReadResponse {
    fn experimental_reason(&self) -> Option<&'static str> {
        self.config.experimental_reason()
    }
}
...
impl crate::experimental_api::ExperimentalApi for ConfigRequirements {
    fn experimental_reason(&self) -> Option<&'static str> {
        ...
        if self.allowed_approvals_reviewers.is_some() {
            return Some("configRequirements/read.allowedApprovalsReviewers");
        }
        if self.hooks.is_some() {
            return Some("configRequirements/read.hooks");
        }
