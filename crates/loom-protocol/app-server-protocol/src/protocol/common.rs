...
impl crate::experimental_api::ExperimentalApi for ServerNotification {
    fn experimental_reason(&self) -> Option<&'static str> {
        match self {
            Self::ThreadSettingsUpdated(..) => Some("thread/settings/updated"),
            Self::ProcessOutputDelta(..) => Some("process/outputDelta"),
            Self::ProcessExited(..) => Some("process/exited"),
            Self::ThreadRealtimeStarted(..) => Some("thread/realtime/started"),
            Self::ThreadRealtimeItemAdded(..) => Some("thread/realtime/itemAdded"),
            Self::ThreadRealtimeTranscriptDelta(..) => Some("thread/realtime/transcript/delta"),
            Self::ThreadRealtimeTranscriptDone(..) => Some("thread/realtime/transcript/done"),
            Self::ThreadRealtimeOutputAudioDelta(..) => Some("thread/realtime/outputAudio/delta"),
            Self::ThreadRealtimeSdp(..) => Some("thread/realtime/sdp"),
            Self::ThreadRealtimeError(..) => Some("thread/realtime/error"),
            Self::ThreadRealtimeClosed(..) => Some("thread/realtime/closed"),
            _ => None,
        }
    }
}
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: loom_protocol::config_types::CollaborationMode {
                        mode: loom_protocol::config_types::ModeKind::Default,
