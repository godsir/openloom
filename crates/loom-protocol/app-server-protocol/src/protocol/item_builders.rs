...
use loom_protocol::protocol::ExecApprovalRequestEvent;
use loom_protocol::protocol::ExecCommandBeginEvent;
use loom_protocol::protocol::ExecCommandEndEvent;
use loom_protocol::protocol::FileChange;
use loom_protocol::protocol::GuardianAssessmentAction;
...
use loom_shell_command::parse_command::parse_command;
...
pub fn guardian_auto_approval_review_notification(
    ...
    let review = GuardianApprovalReview {
        status: match assessment.status {
            loom_protocol::protocol::GuardianAssessmentStatus::InProgress => {
                GuardianApprovalReviewStatus::InProgress
            }
            loom_protocol::protocol::GuardianAssessmentStatus::Approved => {
                GuardianApprovalReviewStatus::Approved
            }
            loom_protocol::protocol::GuardianAssessmentStatus::Denied => {
                GuardianApprovalReviewStatus::Denied
            }
            loom_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                GuardianApprovalReviewStatus::TimedOut
            }
            loom_protocol::protocol::GuardianAssessmentStatus::Aborted => {
