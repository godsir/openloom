...
pub use loom_protocol::protocol::GitSha;
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [loom_protocol::protocol::PatchApplyBeginEvent]
    /// and [loom_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [loom_protocol::protocol::ExecCommandBeginEvent]
    /// and [loom_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
