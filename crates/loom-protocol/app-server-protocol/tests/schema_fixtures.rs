use anyhow::Context;
use anyhow::Result;
use loom_app_server_protocol::generate_json_with_experimental;
use loom_app_server_protocol::generate_typescript_schema_fixture_subtree_for_tests;
use loom_app_server_protocol::read_schema_fixture_subtree;
...
fn schema_root() -> Result<PathBuf> {
    ...
    Ok(PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("schema"))
}
