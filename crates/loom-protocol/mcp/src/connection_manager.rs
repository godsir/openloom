...
use loom_protocol::protocol::McpStartupCompleteEvent;
use loom_protocol::protocol::McpStartupFailure;
use loom_protocol::protocol::McpStartupStatus;
use loom_protocol::protocol::McpStartupUpdateEvent;
use loom_rmcp_client::ElicitationResponse;
...
impl McpConnectionManager {
    ...
    pub async fn new(
        ...
        let codex_apps_auth_provider = auth
            ...
            .map(loom_shim_stubs::model_provider::auth_provider_from_auth);
