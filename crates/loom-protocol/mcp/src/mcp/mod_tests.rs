...
use loom_config::types::AppToolApproval;
...
use loom_protocol::protocol::GranularApprovalConfig;
...
async fn effective_mcp_servers_preserve_user_servers_and_add_codex_apps() {
    ...
    config.configured_mcp_servers.insert(
        ...
        McpServerConfig {
            ...
            environment_id: loom_config::DEFAULT_MCP_SERVER_ENVIRONMENT_ID.to_string(),
            enabled: true,
            required: false,
