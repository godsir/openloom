...
use loom_protocol::approvals::ElicitationRequest;
use loom_protocol::approvals::ElicitationRequestEvent;
use loom_protocol::mcp::RequestId as ProtocolRequestId;
...
use loom_rmcp_client::SendElicitation;
