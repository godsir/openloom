...
use loom_tui_stubs::model_provider_info::WireApi;
use loom_protocol::num_format::format_with_separators;
use loom_protocol::protocol::SessionConfiguredEvent;
use loom_sandbox_summary::summarize_permission_profile;
            ...
            ServerNotification::TurnPlanUpdated(notification) => {
                ...
                for step in notification.plan {
                    match step.status {
                        ...
                        loom_app_server_protocol::TurnPlanStepStatus::InProgress => {
                            eprintln!("  {} {}", "→".style(self.cyan), step.step);
                        }
                        loom_app_server_protocol::TurnPlanStepStatus::Pending => {
                            eprintln!(
                                "  {} {}",
                                "•".style(self.dimmed),
