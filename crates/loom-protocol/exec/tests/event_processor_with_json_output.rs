use loom_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use loom_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use loom_app_server_protocol::CollabAgentTool;
use loom_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use loom_app_server_protocol::CommandAction;
use loom_app_server_protocol::CommandExecutionSource;
use loom_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use loom_app_server_protocol::ErrorNotification;
use loom_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
use loom_app_server_protocol::ItemCompletedNotification;
use loom_app_server_protocol::ItemStartedNotification;
use loom_app_server_protocol::McpToolCallError;
use loom_app_server_protocol::McpToolCallResult;
use loom_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use loom_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use loom_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use loom_app_server_protocol::TurnError;
use loom_app_server_protocol::TurnPlanStep;
use loom_app_server_protocol::TurnPlanStepStatus;
use loom_app_server_protocol::TurnPlanUpdatedNotification;
use loom_app_server_protocol::TurnStartedNotification;
use loom_app_server_protocol::TurnStatus;
use loom_app_server_protocol::WebSearchAction as ApiWebSearchAction;
use loom_protocol::SessionId;
use loom_protocol::ThreadId;
use loom_protocol::models::PermissionProfile;
use loom_protocol::models::WebSearchAction;
...
use loom_exec::AgentMessageItem;
use loom_exec::CodexStatus;
use loom_exec::CollabAgentState;
use loom_exec::CollabAgentStatus;
use loom_exec::CollabTool;
use loom_exec::CollabToolCallItem;
use loom_exec::CollabToolCallStatus;
use loom_exec::CollectedThreadEvents;
use loom_exec::CommandExecutionItem;
use loom_exec::CommandExecutionStatus;
use loom_exec::ErrorItem;
use loom_exec::EventProcessorWithJsonOutput;
use loom_exec::ExecThreadItem;
use loom_exec::FileChangeItem;
use loom_exec::FileUpdateChange as ExecFileUpdateChange;
use loom_exec::ItemCompletedEvent;
use loom_exec::ItemStartedEvent;
use loom_exec::ItemUpdatedEvent;
use loom_exec::McpToolCallItem;
use loom_exec::McpToolCallItemError;
use loom_exec::McpToolCallItemResult;
use loom_exec::McpToolCallStatus;
use loom_exec::PatchApplyStatus;
use loom_exec::PatchChangeKind;
use loom_exec::ReasoningItem;
use loom_exec::ThreadErrorEvent;
use loom_exec::ThreadEvent;
use loom_exec::ThreadItemDetails;
use loom_exec::ThreadStartedEvent;
use loom_exec::TodoItem;
use loom_exec::TodoListItem;
use loom_exec::TurnCompletedEvent;
use loom_exec::TurnFailedEvent;
use loom_exec::TurnStartedEvent;
use loom_exec::Usage;
use loom_exec::WebSearchItem;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_configured = SessionConfiguredEvent {
        ...
        approvals_reviewer: loom_protocol::config_types::ApprovalsReviewer::User,
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            loom_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        loom_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: loom_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
