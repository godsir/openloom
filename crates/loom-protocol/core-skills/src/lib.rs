...
pub mod render {
    ...
    pub fn build_available_skills() -> AvailableSkills { AvailableSkills }
    pub fn default_skill_metadata_budget() -> SkillMetadataBudget { SkillMetadataBudget }
    pub fn render_available_skills_body() -> String { String::new() }
...
pub mod invocation_utils {
    ...
    pub fn detect_implicit_skill_invocation_for_command() -> Option<super::model::SkillMetadata> { None }
}
