...
use loom_app_server_protocol::CommandExecutionRequestApprovalResponse;
use loom_app_server_protocol::FileChangeRequestApprovalResponse;
use loom_app_server_protocol::JSONRPCErrorError;
use loom_app_server_protocol::McpServerElicitationRequestResponse;
use loom_app_server_protocol::PermissionsRequestApprovalResponse;
...
mod tests {
    ...
    use loom_app_server_protocol::McpElicitationObjectType;
    use loom_app_server_protocol::McpElicitationSchema;
    ...
    use loom_app_server_protocol::PermissionGrantScope;
    ...
    use loom_app_server_protocol::ToolRequestUserInputResponse;
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: loom_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: loom_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: loom_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        entries: Some(vec![
                            loom_app_server_protocol::FileSystemSandboxEntry {
                                path: loom_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path),
                                },
                                access: loom_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            loom_app_server_protocol::FileSystemSandboxEntry {
                                path: loom_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(write_path),
                                },
                                access: loom_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: loom_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: loom_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason: loom_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
