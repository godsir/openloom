...
impl ThreadEventStore {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<loom_app_server_protocol::FileUpdateChange>> {
        self.buffer
            .iter()
            .rev()
...
mod tests {
    ...
    use loom_app_server_protocol::HookCompletedNotification;
    use loom_app_server_protocol::HookEventName as AppServerHookEventName;
    use loom_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use loom_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use loom_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use loom_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use loom_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use loom_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use loom_app_server_protocol::HookScope as AppServerHookScope;
    use loom_app_server_protocol::HookStartedNotification;
