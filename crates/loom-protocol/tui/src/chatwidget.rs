...
use loom_app_server_protocol::AppSummary;
use loom_app_server_protocol::CodexErrorInfo as AppServerCodexErrorInfo;
use loom_app_server_protocol::CollabAgentTool;
use loom_app_server_protocol::CollabAgentToolCallStatus;
...
use loom_app_server_protocol::McpServerStatusDetail;
use loom_app_server_protocol::ModelVerification as AppServerModelVerification;
use loom_app_server_protocol::RateLimitReachedType;
...
use loom_app_server_protocol::ThreadGoal as AppThreadGoal;
use loom_app_server_protocol::ThreadGoalStatus as AppThreadGoalStatus;
...
use loom_chatgpt::connectors as chatgpt_connectors;
use loom_config::ConfigLayerStackOrdering;
use loom_config::types::ApprovalsReviewer;
use loom_config::types::Notifications;
use loom_config::types::WindowsSandboxModeToml;
use loom_core_skills::model::SkillMetadata;
use loom_features::FEATURES;
use loom_features::Feature;
#[cfg(test)]
use loom_git_utils::CommitLogEntry;
use loom_git_utils::current_branch_name;
use loom_git_utils::get_git_repo_root;
use loom_git_utils::local_git_branches;
use loom_git_utils::recent_commits;
...
use loom_protocol::approvals::GuardianAssessmentAction;
use loom_protocol::approvals::GuardianAssessmentDecisionSource;
use loom_protocol::approvals::GuardianAssessmentEvent;
use loom_protocol::approvals::GuardianAssessmentStatus;
...
use loom_protocol::plan_tool::PlanItemArg as UpdatePlanItemArg;
use loom_protocol::plan_tool::StepStatus as UpdatePlanItemStatus;
use loom_protocol::request_permissions::RequestPermissionsEvent;
use loom_protocol::user_input::ByteRange;
...
pub(crate) struct ChatWidgetInit {
    ...
    pub(crate) feedback: loom_tui_stubs::feedback::CodexFeedback,
...
pub(crate) struct ChatWidget {
    ...
    feedback: loom_tui_stubs::feedback::CodexFeedback,
...
fn request_permissions_from_params(
    params: loom_app_server_protocol::PermissionsRequestApprovalParams,
