...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: loom_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<loom_protocol::openai_models::ReasoningEffort>,
