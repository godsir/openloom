...
use loom_app_server_protocol::Account;
use loom_app_server_protocol::AskForApproval;
use loom_app_server_protocol::AuthMode;
use loom_app_server_protocol::ClientRequest;
use loom_app_server_protocol::ConfigBatchWriteParams;
use loom_app_server_protocol::ConfigWriteResponse;
use loom_app_server_protocol::ExternalAgentConfigDetectParams;
use loom_app_server_protocol::ExternalAgentConfigDetectResponse;
use loom_app_server_protocol::ExternalAgentConfigImportParams;
use loom_app_server_protocol::ExternalAgentConfigImportResponse;
use loom_app_server_protocol::ExternalAgentConfigMigrationItem;
use loom_app_server_protocol::GetAccountParams;
use loom_app_server_protocol::GetAccountRateLimitsResponse;
use loom_app_server_protocol::GetAccountResponse;
use loom_app_server_protocol::JSONRPCErrorError;
use loom_app_server_protocol::LogoutAccountResponse;
use loom_app_server_protocol::MemoryResetResponse;
use loom_app_server_protocol::Model as ApiModel;
use loom_app_server_protocol::ModelListParams;
use loom_app_server_protocol::ModelListResponse;
use loom_app_server_protocol::RateLimitSnapshot;
use loom_app_server_protocol::RequestId;
use loom_app_server_protocol::ReviewDelivery;
use loom_app_server_protocol::ReviewStartParams;
use loom_app_server_protocol::ReviewStartResponse;
use loom_app_server_protocol::ReviewTarget;
use loom_app_server_protocol::SkillsListParams;
use loom_app_server_protocol::SkillsListResponse;
use loom_app_server_protocol::Thread;
use loom_app_server_protocol::ThreadApproveGuardianDeniedActionParams;
use loom_app_server_protocol::ThreadApproveGuardianDeniedActionResponse;
use loom_app_server_protocol::ThreadBackgroundTerminalsCleanParams;
use loom_app_server_protocol::ThreadBackgroundTerminalsCleanResponse;
use loom_app_server_protocol::ThreadCompactStartParams;
use loom_app_server_protocol::ThreadCompactStartResponse;
use loom_app_server_protocol::ThreadForkParams;
use loom_app_server_protocol::ThreadForkResponse;
use loom_app_server_protocol::ThreadGoalClearParams;
use loom_app_server_protocol::ThreadGoalClearResponse;
use loom_app_server_protocol::ThreadGoalGetParams;
use loom_app_server_protocol::ThreadGoalGetResponse;
use loom_app_server_protocol::ThreadGoalSetParams;
use loom_app_server_protocol::ThreadGoalSetResponse;
use loom_app_server_protocol::ThreadGoalStatus;
use loom_app_server_protocol::ThreadInjectItemsParams;
use loom_app_server_protocol::ThreadInjectItemsResponse;
use loom_app_server_protocol::ThreadListParams;
use loom_app_server_protocol::ThreadListResponse;
use loom_app_server_protocol::ThreadLoadedListParams;
use loom_app_server_protocol::ThreadLoadedListResponse;
use loom_app_server_protocol::ThreadMemoryMode;
use loom_app_server_protocol::ThreadMemoryModeSetParams;
use loom_app_server_protocol::ThreadMemoryModeSetResponse;
use loom_app_server_protocol::ThreadMetadataGitInfoUpdateParams;
use loom_app_server_protocol::ThreadMetadataUpdateParams;
use loom_app_server_protocol::ThreadMetadataUpdateResponse;
use loom_app_server_protocol::ThreadReadParams;
use loom_app_server_protocol::ThreadReadResponse;
use loom_app_server_protocol::ThreadRealtimeAppendAudioParams;
use loom_app_server_protocol::ThreadRealtimeAppendAudioResponse;
use loom_app_server_protocol::ThreadRealtimeAudioChunk;
use loom_app_server_protocol::ThreadRealtimeStartParams;
use loom_app_server_protocol::ThreadRealtimeStartResponse;
use loom_app_server_protocol::ThreadRealtimeStartTransport;
use loom_app_server_protocol::ThreadRealtimeStopParams;
use loom_app_server_protocol::ThreadRealtimeStopResponse;
use loom_app_server_protocol::ThreadResumeParams;
use loom_app_server_protocol::ThreadResumeResponse;
use loom_app_server_protocol::ThreadRollbackParams;
use loom_app_server_protocol::ThreadRollbackResponse;
use loom_app_server_protocol::ThreadSetNameParams;
use loom_app_server_protocol::ThreadSetNameResponse;
use loom_app_server_protocol::ThreadSettingsUpdateParams;
use loom_app_server_protocol::ThreadSettingsUpdateResponse;
use loom_app_server_protocol::ThreadShellCommandParams;
use loom_app_server_protocol::ThreadShellCommandResponse;
use loom_app_server_protocol::ThreadSource;
use loom_app_server_protocol::ThreadStartParams;
use loom_app_server_protocol::ThreadStartResponse;
use loom_app_server_protocol::ThreadStartSource;
use loom_app_server_protocol::ThreadUnsubscribeParams;
use loom_app_server_protocol::ThreadUnsubscribeResponse;
use loom_app_server_protocol::Turn;
use loom_app_server_protocol::TurnInterruptParams;
use loom_app_server_protocol::TurnInterruptResponse;
use loom_app_server_protocol::TurnStartParams;
use loom_app_server_protocol::TurnStartResponse;
use loom_app_server_protocol::TurnSteerParams;
use loom_app_server_protocol::TurnSteerResponse;
use loom_app_server_protocol::UserInput;
use loom_otel_stub::TelemetryAuthMode;
use loom_protocol::ThreadId;
use loom_protocol::approvals::GuardianAssessmentEvent;
...
use loom_protocol::openai_models::ModelAvailabilityNux;
...
pub(crate) struct AppServerBootstrap {
    ...
    pub(crate) plan_type: Option<loom_protocol::account::PlanType>,
...
impl AppServerSession {
    ...
    pub(crate) async fn turn_start(
        ...
        approvals_reviewer: loom_protocol::config_types::ApprovalsReviewer,
        permissions_override: TurnPermissionsOverride,
        workspace_roots: &[AbsolutePathBuf],
        model: String,
        effort: Option<loom_protocol::openai_models::ReasoningEffort>,
        summary: Option<loom_protocol::config_types::ReasoningSummary>,
        service_tier: Option<Option<String>>,
        collaboration_mode: Option<loom_protocol::config_types::CollaborationMode>,
        personality: Option<loom_protocol::config_types::Personality>,
...
pub(crate) fn status_account_display_from_auth_mode(
    ...
    plan_type: Option<loom_protocol::account::PlanType>,
...
fn approvals_reviewer_override_from_config(
    config: &Config,
) -> Option<loom_app_server_protocol::ApprovalsReviewer> {
...
fn sandbox_mode_from_permission_profile(
    ...
    cwd: &std::path::Path,
) -> Option<loom_app_server_protocol::SandboxMode> {
    match permission_profile {
        PermissionProfile::Disabled => {
            Some(loom_app_server_protocol::SandboxMode::DangerFullAccess)
        }
        ...
        PermissionProfile::Managed { .. } => {
            ...
            if file_system_policy.has_full_disk_write_access() {
                permission_profile
                    ...
                    .is_enabled()
                    .then_some(loom_app_server_protocol::SandboxMode::DangerFullAccess)
            } else if file_system_policy.can_write_path_with_cwd(cwd, cwd) {
                Some(loom_app_server_protocol::SandboxMode::WorkspaceWrite)
            } else {
                Some(loom_app_server_protocol::SandboxMode::ReadOnly)
            }
        }
    }
}
...
fn turn_permissions_overrides(
    ...
    Option<loom_app_server_protocol::SandboxPolicy>,
    Option<String>,
) {
...
fn display_permission_profile_from_thread_response(
    sandbox: &loom_app_server_protocol::SandboxPolicy,
    cwd: &std::path::Path,
    config: &Config,
    thread_params_mode: ThreadParamsMode,
) -> PermissionProfile {
...
async fn thread_session_state_from_thread_response(
    ...
    reasoning_effort: Option<loom_protocol::openai_models::ReasoningEffort>,
    config: &Config,
) -> Result<ThreadSessionState, String> {
...
mod tests {
    ...
    use loom_protocol::config_types::ServiceTier;
    use loom_protocol::config_types::Verbosity;
    use loom_protocol::config_types::WebSearchMode;
    use loom_protocol::models::BUILT_IN_PERMISSION_PROFILE_READ_ONLY;
    use loom_protocol::models::BUILT_IN_PERMISSION_PROFILE_WORKSPACE;
    use loom_protocol::models::ManagedFileSystemPermissions;
    ...
    fn rate_limit_snapshot(limit_id: &str) -> RateLimitSnapshot {
        RateLimitSnapshot {
            ...
            limit_name: None,
            primary: Some(loom_app_server_protocol::RateLimitWindow {
                used_percent: 0,
    ...
    fn legacy_turn_permissions_project_to_sandbox_when_explicitly_overridden() {
        ...
        assert_eq!(
            sandbox_policy,
            Some(loom_app_server_protocol::SandboxPolicy::ReadOnly {
    ...
    async fn resume_response_restores_turns_from_thread_items() {
        ...
        let response = ThreadResumeResponse {
            thread: loom_app_server_protocol::Thread {
                ...
                turns: vec![Turn {
                    ...
                    items: vec![
                        loom_app_server_protocol::ThreadItem::UserMessage {
                            id: "user-1".to_string(),
                            content: vec![loom_app_server_protocol::UserInput::Text {
                                text: "hello from history".to_string(),
                                text_elements: Vec::new(),
                            }],
                        },
                        loom_app_server_protocol::ThreadItem::AgentMessage {
            ...
            instruction_sources: vec![test_path_buf("/tmp/project/loom.md").abs()],
    ...
    async fn embedded_thread_response_uses_local_config_profile() {
        ...
        assert_eq!(
            display_permission_profile_from_thread_response(
                &loom_app_server_protocol::SandboxPolicy::DangerFullAccess,
                cwd.as_path(),
                &config,
                ThreadParamsMode::Embedded,
            ),
    ...
    async fn session_configured_populates_history_metadata() {
        ...
        loom_tui_stubs::message_history::append_entry("newer", &thread_id, &history_config)
            .await
            .expect("history append should succeed");
        ...
        let session = thread_session_state_from_thread_response(
            ...
            loom_protocol::config_types::ApprovalsReviewer::User,
            PermissionProfile::read_only(),
            /*active_permission_profile*/ None,
            test_path_buf("/tmp/project").abs(),
            Vec::new(),
    ...
    fn status_account_display_from_auth_mode_uses_remapped_plan_labels() {
        let business = status_account_display_from_auth_mode(
            Some(AuthMode::Chatgpt),
            Some(loom_protocol::account::PlanType::EnterpriseCbpUsageBased),
        );
        assert!(matches!(
            business,
            Some(StatusAccountDisplay::ChatGpt {
        ...
        let team = status_account_display_from_auth_mode(
            Some(AuthMode::Chatgpt),
            Some(loom_protocol::account::PlanType::SelfServeBusinessUsageBased),
        );
        assert!(matches!(
            team,
            Some(StatusAccountDisplay::ChatGpt {
