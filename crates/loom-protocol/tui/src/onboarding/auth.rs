...
use loom_app_server_protocol::CancelLoginAccountParams;
...
fn onboarding_request_id() -> loom_app_server_protocol::RequestId {
    loom_app_server_protocol::RequestId::String(Uuid::new_v4().to_string())
}
...
pub(super) async fn cancel_login_attempt(
    ...
    let _ = request_handle
        .request_typed::<loom_app_server_protocol::CancelLoginAccountResponse>(
    ...
    async fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let client = InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            environment_manager: Arc::new(
                loom_app_server_client::EnvironmentManager::default_for_tests(),
            ),
