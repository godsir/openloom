...
async fn interrupted_turn_after_goal_budget_limited_uses_budget_message_snapshot() {
    ...
    chat.handle_server_notification(
        loom_app_server_protocol::ServerNotification::TurnStarted(
    ...
    chat.handle_server_notification(
        loom_app_server_protocol::ServerNotification::ThreadGoalUpdated(
            loom_app_server_protocol::ThreadGoalUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: Some("turn-1".to_string()),
                goal: loom_app_server_protocol::ThreadGoal {
                    thread_id: "thread-1".to_string(),
                    objective: "Run until the token budget is limited".to_string(),
                    status: loom_app_server_protocol::ThreadGoalStatus::BudgetLimited,
    ...
    chat.handle_server_notification(
        loom_app_server_protocol::ServerNotification::TurnCompleted(
            loom_app_server_protocol::TurnCompletedNotification {
                ...
                turn: loom_app_server_protocol::Turn {
                    ...
                    items_view: loom_app_server_protocol::TurnItemsView::Full,
                    items: Vec::new(),
                    status: loom_app_server_protocol::TurnStatus::Interrupted,
                    error: None,
                    started_at: None,
                    completed_at: None,
                    duration_ms: None,
