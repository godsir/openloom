...
fn app_server_exec_approval_request_preserves_permissions_context() {
    ...
    let request = exec_approval_request_from_params(
        AppServerCommandExecutionRequestApprovalParams {
            ...
            approval_id: Some("approval-1".to_string()),
            reason: None,
            network_approval_context: Some(loom_app_server_protocol::NetworkApprovalContext {
                host: "example.com".to_string(),
                protocol: loom_app_server_protocol::NetworkApprovalProtocol::Socks5Tcp,
            }),
    ...
    assert_eq!(
        ...
        Some(loom_app_server_protocol::NetworkApprovalContext {
            host: "example.com".to_string(),
            protocol: loom_app_server_protocol::NetworkApprovalProtocol::Socks5Tcp,
        })
    );
...
async fn network_exec_approval_history_describes_session_host_allowance() {
    ...
    let request = exec_approval_request_from_params(
        AppServerCommandExecutionRequestApprovalParams {
            ...
            network_approval_context: Some(loom_app_server_protocol::NetworkApprovalContext {
                host: "example.com".to_string(),
                protocol: loom_app_server_protocol::NetworkApprovalProtocol::Https,
            }),
...
async fn network_exec_approval_history_describes_one_time_host_allowance() {
    ...
    let request = exec_approval_request_from_params(
        AppServerCommandExecutionRequestApprovalParams {
            ...
            network_approval_context: Some(loom_app_server_protocol::NetworkApprovalContext {
                host: "example.com".to_string(),
                protocol: loom_app_server_protocol::NetworkApprovalProtocol::Http,
            }),
            command: None,
            cwd: None,
            command_actions: None,
