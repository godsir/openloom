use super::*;
use loom_app_server_protocol::NetworkAccess;
use loom_app_server_protocol::SandboxPolicy;
...
async fn forked_thread_history_line_without_name_shows_id_once_snapshot() {
    ...
    chat.config.codex_home = loom_absolute_path::AbsolutePathBuf::from_absolute_path(temp.path())
