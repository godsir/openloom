...
async fn copy_shortcut_can_be_remapped() {
    ...
    keymap_config.global.copy = Some(loom_config::types::KeybindingsSpec::One(
        loom_config::types::KeybindingSpec("ctrl-x".to_string()),
    ));
    let runtime_keymap =
        ...
        ServerNotification::ThreadGoalUpdated(
            loom_app_server_protocol::ThreadGoalUpdatedNotification {
                ...
                goal: loom_app_server_protocol::ThreadGoal {
                    ...
                    status: loom_app_server_protocol::ThreadGoalStatus::Active,
                    token_budget: None,
                    tokens_used: 0,
                    time_used_seconds: 0,
                    created_at: 1,
