...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: loom_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, loom_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                loom_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                loom_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                loom_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                loom_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                loom_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                loom_app_server_protocol::GuardianRiskLevel::Low => {
                    loom_protocol::approvals::GuardianRiskLevel::Low
                }
                loom_app_server_protocol::GuardianRiskLevel::Medium => {
                    loom_protocol::approvals::GuardianRiskLevel::Medium
                }
                loom_app_server_protocol::GuardianRiskLevel::High => {
                    loom_protocol::approvals::GuardianRiskLevel::High
                }
                loom_app_server_protocol::GuardianRiskLevel::Critical => {
                    loom_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    loom_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        loom_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    loom_app_server_protocol::GuardianUserAuthorization::Low => {
                        loom_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    loom_app_server_protocol::GuardianUserAuthorization::Medium => {
                        loom_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    loom_app_server_protocol::GuardianUserAuthorization::High => {
                        loom_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                loom_app_server_protocol::AutoReviewDecisionSource::Agent => {
