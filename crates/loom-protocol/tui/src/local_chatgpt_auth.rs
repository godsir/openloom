...
use loom_tui_stubs::login::load_auth_dot_json;
...
mod tests {
    ...
    use chrono::Utc;
    use loom_app_server_protocol::AuthMode;
    use loom_tui_stubs::login::AuthDotJson;
    use loom_tui_stubs::login::auth::login_with_chatgpt_auth_tokens;
    use loom_tui_stubs::login::save_auth;
    use loom_tui_stubs::login::token_data::TokenData;
    ...
    fn write_chatgpt_auth(codex_home: &Path, plan_type: &str) {
        ...
        let auth = AuthDotJson {
            ...
            tokens: Some(TokenData {
                id_token: loom_tui_stubs::login::token_data::parse_chatgpt_jwt_claims(&id_token)
