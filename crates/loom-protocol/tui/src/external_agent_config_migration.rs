...
use loom_app_server_protocol::PluginsMigration;
...
mod tests {
    ...
    use crate::tui::FrameRequester;
    use loom_app_server_protocol::ExternalAgentConfigMigrationItem;
    use loom_app_server_protocol::ExternalAgentConfigMigrationItemType;
    use loom_app_server_protocol::PluginsMigration;
    use crossterm::event::KeyCode;
    use crossterm::event::KeyEvent;
    use crossterm::event::KeyModifiers;
    ...
    fn sample_plugin_details() -> loom_app_server_protocol::MigrationDetails {
        loom_app_server_protocol::MigrationDetails {
            plugins: vec![
                PluginsMigration {
