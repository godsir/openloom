...
impl AppLinkViewParams {
    pub(crate) fn from_url_app_server_request(
        ...
        request: &loom_app_server_protocol::McpServerElicitationRequest,
    ) -> Option<Self> {
        let loom_app_server_protocol::McpServerElicitationRequest::Url {
            meta,
            message,
            url,
            elicitation_id,
...
mod tests {
    ...
    fn auth_url_request(url: &str) -> loom_app_server_protocol::McpServerElicitationRequest {
    ...
    fn non_codex_apps_url_elicitation_builds_generic_app_link_params() {
        ...
        let request = loom_app_server_protocol::McpServerElicitationRequest::Url {
            meta: None,
