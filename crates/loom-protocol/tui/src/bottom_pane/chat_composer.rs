...
use loom_protocol::user_input::MAX_USER_INPUT_TEXT_CHARS;
...
#[cfg(test)]
use loom_core_skills::model::SkillInterface;
use loom_core_skills::model::SkillMetadata;
use loom_file_search::FileMatch;
#[cfg(test)]
use loom_tui_stubs::plugin::AppConnectorId;
...
mod tests {
    ...
    fn footer_hint_row_is_separated_from_composer() {
        ...
        let composer = ChatComposer::new(
            ...
            "Ask Loom to do anything".to_string(),
...
程序员 与 Unicode 同行";
    ...
    fn file_completion_preserves_large_paste_placeholder_elements() {
        ...
        composer.on_file_search_result(
            ...
            vec![FileMatch {
                ...
                match_type: loom_file_search::MatchType::File,
    ...
    fn pasting_filepath_attaches_image() {
        ...
        let tmp_path: PathBuf = tmp.path().join("loom_tui_test_paste_image.png");
