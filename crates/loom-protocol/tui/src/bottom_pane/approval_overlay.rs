...
use loom_app_server_protocol::FileSystemAccessMode;
use loom_app_server_protocol::FileSystemPath;
use loom_app_server_protocol::FileSystemSandboxEntry;
use loom_app_server_protocol::FileSystemSpecialPath;
use loom_app_server_protocol::McpServerElicitationAction;
use loom_app_server_protocol::NetworkApprovalContext;
use loom_app_server_protocol::NetworkApprovalProtocol;
...
impl ApprovalOverlay {
    ...
    fn handle_permissions_decision(
        ...
        self.app_event_tx.request_permissions_response(
            thread_id,
            call_id.to_string(),
            loom_protocol::request_permissions::RequestPermissionsResponse {
    ...
    available_decisions
        ...
        .filter_map(|decision| match decision {
            ...
            CommandExecutionApprovalDecision::Cancel => Some(ApprovalOption {
                label: "No, and tell Loom what to do differently".to_string(),
    ...
    fn network_exec_options_use_expected_labels_and_hide_execpolicy_amendment() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "Yes, and allow this host for this conversation".to_string(),
                "Yes, and allow this host in the future".to_string(),
                "No, and tell Loom what to do differently".to_string(),
            ]
        );
    }
