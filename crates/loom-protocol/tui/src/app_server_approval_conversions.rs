...
use loom_app_server_protocol::GrantedPermissionProfile;
    ...
    fn converts_request_permissions_into_granted_permissions() {
        assert_eq!(
            granted_permission_profile_from_request(CoreRequestPermissionProfile::from(
                loom_app_server_protocol::RequestPermissionProfile {
                    network: Some(loom_app_server_protocol::AdditionalNetworkPermissions {
                        enabled: Some(true),
                    }),
                    file_system: Some(loom_app_server_protocol::AdditionalFileSystemPermissions {
            ...
            loom_app_server_protocol::GrantedPermissionProfile {
                network: Some(loom_app_server_protocol::AdditionalNetworkPermissions {
                    enabled: Some(true),
                }),
                file_system: Some(loom_app_server_protocol::AdditionalFileSystemPermissions {
            ...
            granted_permission_profile_from_request(CoreRequestPermissionProfile::from(
                loom_app_server_protocol::RequestPermissionProfile {
                    ...
                    file_system: Some(loom_app_server_protocol::AdditionalFileSystemPermissions {
                        ...
                        write: None,
                        glob_scan_max_depth: None,
                        entries: Some(vec![loom_app_server_protocol::FileSystemSandboxEntry {
                            path: loom_app_server_protocol::FileSystemPath::Special {
                                value: loom_app_server_protocol::FileSystemSpecialPath::Root,
                            },
                            access: loom_app_server_protocol::FileSystemAccessMode::Write,
                        }]),
                    }),
