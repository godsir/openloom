...
use loom_config::types::SessionPickerViewMode;
use loom_protocol::ThreadId;
use loom_path_utils as path_utils;
            ...
            ThreadItem::UserMessage { content, .. } => Some(TranscriptPreviewLine {
                ...
                text: content
                    ...
                    .filter_map(|input| match input {
                        loom_app_server_protocol::UserInput::Text { text, .. } => {
                            Some(text.as_str())
                        }
                        _ => None,
                    })
...
mod tests {
    use super::*;
    use chrono::Duration;
    use loom_config::CONFIG_TOML_FILE;
    use loom_protocol::ThreadId;
...
"#
    ...
    fn thread_to_transcript_cells_renders_core_message_types() {
        ...
        let thread = Thread {
            ...
            git_info: None,
            name: None,
            turns: vec![loom_app_server_protocol::Turn {
