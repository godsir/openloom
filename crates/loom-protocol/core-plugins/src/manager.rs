...
use loom_shim_stubs::analytics::AnalyticsEventsClient;
use loom_shim_stubs::config::ConfigLayerStack;
use loom_shim_stubs::config::PluginConfigEdit;
use loom_shim_stubs::config::apply_user_plugin_config_edits;
use loom_shim_stubs::config::clear_user_plugin;
use loom_shim_stubs::config::set_user_plugin_enabled;
...
use loom_hooks::plugin_hook_declarations;
...
use loom_shim_stubs::plugin::prompt_safe_plugin_description;
...
impl PluginsManager {
    ...
    pub async fn read_plugin_detail_for_marketplace_plugin(
        ...
        let resolved_skills = load_plugin_skills(
            ...
            &manifest.paths,
            self.restriction_product,
            &loom_core_skills::config_rules::skill_config_rules_from_stack(
                &config.config_layer_stack,
            ),
        )
        .await;
