...
use loom_shim_stubs::config::types::McpServerConfig;
use loom_shim_stubs::config::types::PluginConfig;
use loom_shim_stubs::config::types::PluginMcpServerConfig;
use loom_core_skills::SkillMetadata;
use loom_core_skills::config_rules::SkillConfigRules;
use loom_core_skills::config_rules::resolve_disabled_skill_paths;
use loom_core_skills::config_rules::skill_config_rules_from_stack;
use loom_core_skills::loader::SkillRoot;
use loom_core_skills::loader::load_skills_from_roots;
use loom_exec_server::LOCAL_FS;
use loom_shim_stubs::plugin::AppConnectorId;
use loom_shim_stubs::plugin::LoadedPlugin;
use loom_shim_stubs::plugin::PluginCapabilitySummary;
use loom_shim_stubs::plugin::PluginHookSource;
use loom_shim_stubs::plugin::PluginId;
use loom_shim_stubs::plugin::PluginIdError;
use loom_shim_stubs::plugin::PluginLoadOutcome;
use loom_shim_stubs::plugin::PluginTelemetryMetadata;
