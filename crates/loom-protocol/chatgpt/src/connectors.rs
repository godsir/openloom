...
use loom_tui_stubs::connectors::ConnectorDirectoryCacheContext;
use loom_tui_stubs::connectors::ConnectorDirectoryCacheKey;
use loom_tui_stubs::connectors::DirectoryListResponse;
use loom_tui_stubs::connectors::filter::filter_disallowed_connectors;
use loom_tui_stubs::connectors::merge::merge_connectors;
use loom_tui_stubs::connectors::merge::merge_plugin_connectors;
use loom_tui_stubs::config::Config;
pub use loom_tui_stubs::connectors::list_accessible_connectors_from_mcp_tools;
pub use loom_tui_stubs::connectors::list_accessible_connectors_from_mcp_tools_with_environment_manager;
pub use loom_tui_stubs::connectors::list_accessible_connectors_from_mcp_tools_with_options;
pub use loom_tui_stubs::connectors::list_accessible_connectors_from_mcp_tools_with_options_and_status;
pub use loom_tui_stubs::connectors::list_cached_accessible_connectors_from_mcp_tools;
pub use loom_tui_stubs::connectors::with_app_enabled_state;
use loom_core_plugins::PluginsManager;
use loom_shim_stubs::login::AuthManager;
use loom_shim_stubs::login::CodexAuth;
use loom_shim_stubs::login::default_client::originator;
use loom_shim_stubs::plugin::AppConnectorId;
...
pub async fn list_cached_all_connectors(config: &Config) -> Option<Vec<AppInfo>> {
    ...
    let connectors = loom_tui_stubs::connectors::cached_directory_connectors(&cache_context)?;
...
pub async fn list_all_connectors_with_options(
    ...
    let cache_context = connector_directory_cache_context(config, &auth);
    let connectors = loom_tui_stubs::connectors::list_all_connectors_with_options(
        cache_context,
...
mod tests {
    use super::*;
    use loom_tui_stubs::connectors::metadata::connector_install_url;
    use loom_shim_stubs::plugin::AppConnectorId;
