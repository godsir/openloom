...
impl<'a> BridgeStore<'a> {
    ...
    pub fn ensure_session(&self, platform: &str, chat_id: &str, sender_name: &str) -> Result<String> {
    ...
    pub fn record_message(&self, session_id: &str, direction: &str, content: &str, external_msg_id: &str) -> Result<()> {
        self.conn.execute(
