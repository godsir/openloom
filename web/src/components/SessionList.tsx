      ...
      {showEmptyState ? (
        ...
        return (
          <Fragment key={section.id}>
            <div key={`${section.id}-title`} className={styles.sessionSectionTitle}>{t(section.titleKey)}</div>
            {items}
          </Fragment>
        );
      })}
  ...
  return (
    <>
      ...
      >
        ...
        <div className={styles.sessionArchiveBtn} title={t('session.delete')} onClick={handleArchive}>
